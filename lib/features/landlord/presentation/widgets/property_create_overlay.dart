...
class PropertyCreateOverlay extends StatefulWidget {
  final VoidCallback onClose;
  final int ownerPartnerId;

  const PropertyCreateOverlay({
    super.key,
  ...
  @override
  State<PropertyCreateOverlay> createState() => _PropertyCreateOverlayState();
}
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final propertyId = await repo.createPropertyReturningId(
        ownerPartnerId: widget.ownerPartnerId,
        name: name,
